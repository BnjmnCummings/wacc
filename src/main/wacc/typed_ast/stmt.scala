...
sealed trait Q_Stmt // TODO: Add types for read, free, return, etc.
...
case class Q_Read(l: Q_LValue, pos: (Int, Int) = (0, 0)) extends Q_Stmt // int, char
case class Q_Free(x: Q_Expr, pos: (Int, Int) = (0, 0)) extends Q_Stmt // t[], pair(t, o)
case class Q_Return(x: Q_Expr, pos: (Int, Int) = (0, 0)) extends Q_Stmt // t
case class Q_Exit(x: Q_Expr, pos: (Int, Int) = (0, 0)) extends Q_Stmt
case class Q_Print(x: Q_Expr, pos: (Int, Int) = (0, 0)) extends Q_Stmt // t
case class Q_Println(x: Q_Expr, pos: (Int, Int) = (0, 0)) extends Q_Stmt // t
