...
case class A_And(opD: A_RegDeref, opS: A_Operand, opSize: A_OperandSize) extends A_Instr
case class A_Or(opD: A_RegDeref, opS: A_Operand, opSize: A_OperandSize) extends A_Instr
